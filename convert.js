...
modified_substring = modified_substring.replace( /([\{])([कखगघङचछजझञटठडढणतथदधनपफबभमयरलळवशषसहक़ख़ग़ज़ड़ढ़फ़य़ऱऩ])/g , "$2$1" ) ;

modified_substring = modified_substring.replace( /([\{])((्[कखगघङचछजझञटठडढणतथदधनपफबभमयरलळवशषसहक़ख़ग़ज़ड़ढ़फ़य़ऱऩ])+)/g , "$2$1" ) ;

modified_substring = modified_substring.replace( /\{/g , "ि" ) ;


// Following three statement for adjusting position of reph ie, half r .

modified_substring = modified_substring.replace( /([कखगघङचछजझञटठडढणतथदधनपफबभमयरलळवशषसहक़ख़ग़ज़ड़ढ़फ़य़ऱऩ])([ािीुूृेैोौंँ]*)([©])/g , "$3$1$2" ) ;

modified_substring = modified_substring.replace( /(([कखगघङचछजझञटठडढणतथदधनपफबभमयरलळवशषसहक़ख़ग़ज़ड़ढ़फ़य़ऱऩ][्])+)([©])/g, "$3$1" ) ;
// Z is $3 here, NOT $2.
